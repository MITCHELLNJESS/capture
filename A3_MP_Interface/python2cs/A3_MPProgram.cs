...
/// <summary>
/// Runs A3MPDataMsgPublisher or A3MPDataMsgSubscriber.
/// </summary>
public static class A3MPDataMsgProgram
{
    /// <summary>
    ...
    public static void Main(string[] args)
    {
        ...
        if (arguments.Pub)
        {
            Console.WriteLine($"Running A3MPDataMsgPublisher on domain {arguments.Domain}");
            A3MPDataMsgPublisher.RunPublisher(arguments.Domain, arguments.SampleCount);
        }
        else
        {
            Console.WriteLine($"Running A3MPDataMsgSubscriber on domain {arguments.Domain}");
            A3MPDataMsgSubscriber.RunSubscriber(arguments.Domain, arguments.SampleCount);
        }
    }
