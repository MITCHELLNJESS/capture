...
////{
////    private static int ProcessData(DataReader<A3MPDataMsg> reader)
////    {
...
////                {
////                    Console.WriteLine(sample.Data.data);
////                    samplesRead++;
////                }
////                else
////                {
...
////        Topic<A3MPDataMsg> topic = participant.CreateTopic<A3MPDataMsg>("A3MPDataMsg");
...
////        DataReader<A3MPDataMsg> reader = subscriber.CreateDataReader(topic);
...
//        private const string TopicName = "A3MPMsgData";
